...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def.Name := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.effectKeysByHashedKeyName.List.parentEffectKeyHandler.def,"UTF-16", [0x38])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.lastMaxHealth := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Double", [0x3d0])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.overwhelm := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Int", [0x360])
...
this.game.gameInstances.ActiveCampaignData.currentRules.MonsterDamageModifier := New GameObjectStructure(this.game.gameInstances.ActiveCampaignData.currentRules,"Double", [0x368])
